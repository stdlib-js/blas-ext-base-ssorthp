...
```javascript
import ssorthp from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-ssorthp@v0.0.9-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-ssorthp/actions/workflows/test.yml/badge.svg?branch=v0.0.9
[test-url]: https://github.com/stdlib-js/blas-ext-base-ssorthp/actions/workflows/test.yml?query=branch:v0.0.9
