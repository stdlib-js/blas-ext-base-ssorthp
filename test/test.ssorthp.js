...
tape( 'the function has an arity of 4', function test( t ) {
	t.strictEqual( ssorthp.length, 4, 'has expected arity' );
	t.end();
});
...
tape( 'if `order` equals `0`, the function returns the output array unchanged', function test( t ) {
	var expected;
	var x;
